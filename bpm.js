...
<body style="margin: revert">
  <form class="row g-3 needs-validation" id="form" novalidate>
    ...
    <div class="row">
      <div class="col-md-12">
        <label for="SupAproJusti" class="form-label">Motivo Reprovação Supervisor Suprimentos *caso aprovação for reprovada</label>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <input disabled id="Fornec" type="text" required
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
        <div class="invalid-feedback">*Campo Obrigatório</div>
      </div>
    ...
    <!-- Número da NF -->
    <div class="row" id="PagNumNf" style="display: none;">
      <div class="col-md-6">
        <label for="NumNf" class="form-label">CNPJ do Tomador</label>
        <input disabled id="NumNf" type="text"
          class="form-control ng-pristine ng-untouched ng-scope ng-empty ng-valid-pattern ng-valid ng-valid-required">
          <script type="text/javascript">
            $('#NumNf').mask('000.000.000-00', {
              onKeyPress: function (NumNf, e, field, options) {
                const masks = ['00.000.000/0000-00'];
                const mask = (Cnpj.length > 14) ? masks[1] : masks[0];
                $('#NumNf').mask(mask, options);
              }
            });
          </script>
        <div class="invalid-feedback">*Campo Obrigatório</div>
